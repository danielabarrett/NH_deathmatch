...
execute as @a[team=RED,scores={death_detector=1..},nbt={Health:20.0f}] run function warfare:deathmatch/death_red
execute as @a[team=BLUE,scores={death_detector=1..},nbt={Health:20.0f}] run function warfare:deathmatch/death_blue
...
execute if score COUNTDOWN_CLOCK clock matches 1 run function warfare:deathmatch/start
...
execute if score GAME_CLOCK clock matches 1 run function warfare:deathmatch/game_over
...
# execute as @a[scores={clock=1},team=RED] run function warfare:deathmatch/respawn_red
# execute as @a[scores={clock=1},team=BLUE] run function warfare:deathmatch/respawn_blue
...
execute as @a[scores={loadout_equip=1..}] run function warfare:deathmatch/loadouts/equip_current
