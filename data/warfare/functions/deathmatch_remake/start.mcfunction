...
effect clear @a
# execute as @a[scores={loadout_select=1},team=RED] run function warfare:deathmatch_remake/loadouts/get_red_1
# execute as @a[scores={loadout_select=2},team=RED] run function warfare:deathmatch_remake/loadouts/get_red_2
# execute as @a[scores={loadout_select=1},team=BLUE] run function warfare:deathmatch_remake/loadouts/get_blue_1
# execute as @a[scores={loadout_select=2},team=BLUE] run function warfare:deathmatch_remake/loadouts/get_blue_2
...
execute as @a[team=RED] run function warfare:deathmatch_remake/respawn_red
execute as @a[team=BLUE] run function warfare:deathmatch_remake/respawn_blue
...
scoreboard objectives add killcount dummy {"text":"Team deathmatch_remake","color":"gold","bold":true}
...
function warfare:deathmatch_remake/calculate_time_remaining
