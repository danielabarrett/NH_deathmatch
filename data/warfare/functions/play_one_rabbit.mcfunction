...
# execute as @e[type=armor_stand,name="spawn_rabbit2"] run scoreboard players add setup_counter utility 1
# execute as @e[type=armor_stand,name="spawn_rabbit3"] run scoreboard players add setup_counter utility 1
