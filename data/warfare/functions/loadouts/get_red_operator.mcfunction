...
# weapons
item replace entity @s hotbar.0 with additionalguns:pp_19{Attachments:{Stock:{id:'cgm:tactical_stock',Count:1b},Barrel:{id:"additionalguns:tactical_muzzle_brake",Count:1b}}}
