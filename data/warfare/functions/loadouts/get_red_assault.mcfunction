...
# weapons
item replace entity @s hotbar.0 with additionalguns:ak104{Attachments:{Under_Barrel:{id:'additionalguns:angled_grip',Count:1b},Barrel:{id:'additionalguns:tactical_muzzle_brake',Count:1b}}}
