...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{loadout_sniper:1b}}}] run scoreboard players set @s loadout_select 3
execute if entity @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{loadout_sniper:1b}}}] run tellraw @s [{"text":"Selected ","color":"yellow"},{"text":"Sniper","color":"yellow","bold":true}]
