...
# execute as @a[scores={clock=1},team=RED] run function warfare:president/respawn_red
# execute as @a[scores={clock=1},team=BLUE] run function warfare:president/respawn_blue


# respawn
execute as @a[scores={clock=1}] run scoreboard players set @s player_respawning 1
execute as @a[team=RED,scores={player_respawning=1}] as @e[type=armor_stand,name="respawn_red",limit=1,sort=random] at @s unless entity @a[team=!RED,distance=..5] run function warfare:president/respawn_red
execute as @a[team=BLUE,scores={player_respawning=1}] as @e[type=armor_stand,name="respawn_blue",limit=1,sort=random] at @s unless entity @a[team=!BLUE,distance=..5] run function warfare:president/respawn_blue
...
execute if score second_detector clock matches 2 run function warfare:president/calculate_time_remaining
scoreboard players operation second_detector clock = GAME_CLOCK clock
