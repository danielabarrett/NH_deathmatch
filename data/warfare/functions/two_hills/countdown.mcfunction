...
function warfare:two_hills/fillteams
...
bossbar add timer {"text":"Two Hills","color":"gold"}
bossbar set timer name {"text":"Two Hills","color":"gold"}
...
execute as @a[team=RED] run function warfare:two_hills/loadouts/sel_red_1
execute as @a[team=BLUE] run function warfare:two_hills/loadouts/sel_blue_1
...
scoreboard players set @e[type=armor_stand,name="hill_a"] utility 0
execute as @e[type=armor_stand,name="hill_a"] at @e[type=armor_stand,name="hill_a"] run function warfare:two_hills/hill/spawn_border_a
scoreboard players set @e[type=armor_stand,name="hill_b"] utility 0
execute as @e[type=armor_stand,name="hill_b"] at @e[type=armor_stand,name="hill_b"] run function warfare:two_hills/hill/spawn_border_b
