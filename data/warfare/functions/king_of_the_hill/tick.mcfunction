...
execute as @a[team=RED,scores={death_detector=1..},nbt={Health:20.0f}] run function warfare:king_of_the_hill/death_red
execute as @a[team=BLUE,scores={death_detector=1..},nbt={Health:20.0f}] run function warfare:king_of_the_hill/death_blue
...
execute if score COUNTDOWN_CLOCK clock matches 1 run function warfare:king_of_the_hill/start
...
execute if score GAME_CLOCK clock matches 1 run function warfare:king_of_the_hill/game_over
...
# execute as @a[scores={clock=1},team=RED] run function warfare:king_of_the_hill/respawn_red
# execute as @a[scores={clock=1},team=BLUE] run function warfare:king_of_the_hill/respawn_blue
...
execute if score second_detector clock matches 2 run function warfare:king_of_the_hill/second
scoreboard players operation second_detector clock = GAME_CLOCK clock
...
execute if score second_detector clock matches 2 run function warfare:king_of_the_hill/hill/border_particles
...
execute as @a[scores={loadout_equip=1..}] run function warfare:king_of_the_hill/loadouts/equip_current
