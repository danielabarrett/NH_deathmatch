...
execute as @a[team=RED,scores={death_detector=1..},nbt={Health:20.0f}] run function warfare:one_rabbit/death_red
execute as @a[team=BLUE,scores={death_detector=1..},nbt={Health:20.0f}] run function warfare:one_rabbit/death_blue
execute as @a[team=RABBIT,scores={death_detector=1..},nbt={Health:20.0f}] run function warfare:one_rabbit/death_rabbit
...
execute if score COUNTDOWN_CLOCK clock matches 1 run function warfare:one_rabbit/start
...
execute if score GAME_CLOCK clock matches 1 run function warfare:one_rabbit/game_over
...
execute as @a[team=RABBIT,scores={player_respawning=1}] as @e[type=armor_stand,name="spawn_rabbit",limit=1,sort=random] at @s unless entity @a[team=!RABBIT,distance=..5] run function warfare:one_rabbit/respawn_rabbit
